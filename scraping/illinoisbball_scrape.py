...
def get_illinoisMBB_data():      
    time.sleep(1) 
    website = 'https://www.espn.com/mens-college-basketball/team/schedule/_/id/356/illinois-fighting-illini'
    ...
    with open("IllinoisMBBData.csv", "w") as l:
        writer = csv.writer(l)
